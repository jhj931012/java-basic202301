...
public class Main {
    public static void main(String[] args) {
        ...
        Dancer streetDancer1 = new StreetDancer("스트릿댄서팀1", "스트릿댄서1");
        Dancer streetDancer2 = new StreetDancer("스트릿댄서팀2", "스트릿댄서2");
        Dancer streetDancer3 = new StreetDancer("스트릿댄서팀3", "스트릿댄서3");
